...
You must return ONLY a single valid JSON object matching this schema:
{
  ...
  "quality_flags": ["subset of: missing_metrics, small_cohort, synthetic_data"],
...
### 3. When Unsure
- If the paper topic is ambiguous or does not fit standard healthcare domains, assign "category": "other" with "confidence" < 0.5. Never guess a category.
